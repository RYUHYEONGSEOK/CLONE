...
HRESULT CFountain::Initialize(void)
{
...
void CFountain::Render(void)
{
	...
	m_pGrapicDevice->m_pDeviceContext->VSSetConstantBuffers(0, 2, &m_pBuffer->m_ConstantBuffer);
	//////////////////
...
CFountain * CFountain::Create(void)
{
	CFountain*	pObj = new CFountain;
...
HRESULT CFountain::AddComponent(void)
{
	CComponent* pComponent = NULL;
	char cModelPath[MAX_PATH] = "../Resource/Land/fountain.FBX";
	...
	m_pTexture = CTexture::Create(L"../Resource/MeshImage/fountain_d.dds");
