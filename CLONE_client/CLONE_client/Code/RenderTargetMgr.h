...
public:
	ID3D11ShaderResourceView* GetReflectionView(void);
	ID3D11ShaderResourceView* GetRefactionView(void);

public:
	void Begin_MRT_Refraction(const TCHAR* pMRTTag);
	void End_MRT_Refraction(const TCHAR* pMRTTag);

	void Begin_MRT_Reflection(const TCHAR* pMRTTag);
	void End_MRT_Reflection(const TCHAR* pMRTTag);
