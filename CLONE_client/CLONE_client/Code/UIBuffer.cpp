...
CUIBuffer::CUIBuffer(CDevice * pDevice)
	: CBuffer(pDevice)
{

}

CUIBuffer::CUIBuffer(const CUIBuffer & rhs)
...
HRESULT CUIBuffer::CreateBuffer(void)
{
	m_dwVtxCnt = 4;
...
CUIBuffer * CUIBuffer::Create(CDevice * pDevice)
{
	CUIBuffer*		pBuffer = new CUIBuffer(pDevice);
...
CResource * CUIBuffer::Clone(void)
{
	++(*m_pRefCnt);
	return new CUIBuffer(*this);
}

void CUIBuffer::Render(DXGIFORMATTYPE eFormatType)
{
...
void CUIBuffer::CreateRasterizerState(void)
{
