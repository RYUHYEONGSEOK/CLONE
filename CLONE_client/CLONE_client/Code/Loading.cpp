...
void CLoading::StageLoading1(void)
{
	...
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Texture Loading...   ../bin/Resources/Mesh/StageMap/KJKPlaza/bridge_d.png");
	CResourceMgr::GetInstance()->Add_Texture(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CTexture::TEXTURE_TYPE_BASIC, L"Texture_Bridge_d", L"../bin/Resources/Mesh/StageMap/KJKPlaza/bridge_d.png");
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Texture Loading...   ../bin/Resources/Mesh/StageMap/KJKPlaza/fountain_d.jpg");
	CResourceMgr::GetInstance()->Add_Texture(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CTexture::TEXTURE_TYPE_BASIC, L"Texture_Fountain_d", L"../bin/Resources/Mesh/StageMap/KJKPlaza/fountain_d.jpg");
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Texture Loading...   ../bin/Resources/Mesh/StageMap/KJKPlaza/building_d.jpg");
	CResourceMgr::GetInstance()->Add_Texture(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CTexture::TEXTURE_TYPE_BASIC, L"Texture_Building_d", L"../bin/Resources/Mesh/StageMap/KJKPlaza/building_d.jpg");
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Texture Loading...   ../bin/Resources/Mesh/StageMap/KJKPlaza/ground_d.png");
	CResourceMgr::GetInstance()->Add_Texture(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CTexture::TEXTURE_TYPE_BASIC, L"Texture_Ground_d", L"../bin/Resources/Mesh/StageMap/KJKPlaza/ground_d.png");
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Texture Loading...   ../bin/Resources/Mesh/StageMap/KJKPool/map2_texture.jpg");
	CResourceMgr::GetInstance()->Add_Texture(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CTexture::TEXTURE_TYPE_BASIC, L"Texture_KJKPool", L"../bin/Resources/Mesh/StageMap/KJKPool/map2_texture.jpg");
	m_bCurrentLoadingCnt++;
	...
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Texture Loading...   ../bin/Resources/Texture/Water/water02.dds");
	CResourceMgr::GetInstance()->Add_Texture(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CTexture::TEXTURE_TYPE_BASIC, L"Texture_Water", L"../bin/Resources/Texture/Water/water02.dds");
	m_bCurrentLoadingCnt++;
	...
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Texture Loading...   ../bin/Resources/Texture/CustomGame/custom_stageimg_.png");
	CResourceMgr::GetInstance()->Add_Texture(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CTexture::TEXTURE_TYPE_BASIC, L"Texture_CustomStageImg", L"../bin/Resources/Texture/CustomGame/custom_stageimg_%d.png", 2);
	m_bCurrentLoadingCnt++;
	...
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Mesh Loading...   ../bin/Resources/Mesh/StageMap/KJKPlaza/ground.FBX");
	CResourceMgr::GetInstance()->Add_Mesh(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CResourceMgr::MESH_TYPE_STATIC, L"Mesh_Ground", "../bin/Resources/Mesh/StageMap/KJKPlaza/ground.FBX");
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Mesh Loading...   ../bin/Resources/Mesh/StageMap/KJKPlaza/bridge.FBX");
	CResourceMgr::GetInstance()->Add_Mesh(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CResourceMgr::MESH_TYPE_STATIC, L"Mesh_Bridge", "../bin/Resources/Mesh/StageMap/KJKPlaza/bridge.FBX");
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Mesh Loading...   ../bin/Resources/Mesh/StageMap/KJKPlaza/building1.FBX");
	CResourceMgr::GetInstance()->Add_Mesh(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CResourceMgr::MESH_TYPE_STATIC, L"Mesh_Building", "../bin/Resources/Mesh/StageMap/KJKPlaza/building1.FBX");
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Mesh Loading...   ../bin/Resources/Mesh/StageMap/KJKPlaza/fountain.FBX");
	CResourceMgr::GetInstance()->Add_Mesh(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CResourceMgr::MESH_TYPE_STATIC, L"Mesh_Fountain", "../bin/Resources/Mesh/StageMap/KJKPlaza/fountain.FBX");
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Mesh Loading...   ../bin/Resources/Mesh/StageMap/KJKPool/map2.FBX");
	CResourceMgr::GetInstance()->Add_Mesh(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CResourceMgr::MESH_TYPE_STATIC, L"Mesh_KJKPool", "../bin/Resources/Mesh/StageMap/KJKPool/map2.FBX");
	m_bCurrentLoadingCnt++;
	...
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Shader Loading...   Shader_Reflection");
	CResourceMgr::GetInstance()->Add_Shader(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CResourceMgr::SHADER_TYPE_REFLECTION, L"Shader_Reflection");
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Shader Loading...   Shader_Refaction");
	CResourceMgr::GetInstance()->Add_Shader(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CResourceMgr::SHADER_TYPE_REFACTION, L"Shader_Refaction");
	m_bCurrentLoadingCnt++;
	lstrcpy(m_szLoadingMessage, L"Shader Loading...   Shader_RefactionForDynamic");
	CResourceMgr::GetInstance()->Add_Shader(m_pDevice, CResourceMgr::RESOURCE_ATTRI_DYNAMIC,
		CResourceMgr::SHADER_TYPE_REFACTIONFORDYNAMIC, L"Shader_RefactionForDynamic");
	m_bCurrentLoadingCnt++;

	//NaviMesh Load == 1
	lstrcpy(m_szLoadingMessage, L"NaviMesh Loading...   ");
	LoadNaviMesh();
	m_bCurrentLoadingCnt++;
...
HRESULT CLoading::LoadNaviMesh(void)
{
	for (int i = 0; i < MAP_END; ++i)
	{
		...
		if (i == MAP_KJK_PLAZA)
			hFile = CreateFile(L"../bin/Navi/Map1Navi.dat", GENERIC_READ, 0, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
		else if (i == MAP_KJK_POOL)
			hFile = CreateFile(L"../bin/Navi/Map2Navi.dat", GENERIC_READ, 0, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
		...
		CNaviMgr::GetInstance()->Reserve_CellContainerSize(m_pDevice, iCount, (eMapType)i);
		...
		while (iSize < iCount)
		{
			...
			CNaviMgr::GetInstance()->AddCell(&vPoint1, &vPoint2, &vPoint3, (eMapType)i);
			++iSize;
		}
