...
public:
	...
	void Set_Target_Reflaction(void);
...
public:
	ID3D11ShaderResourceView* GetReflectionView(void) { return m_pReflectionResourceView; }
	ID3D11ShaderResourceView* GetRefactionView(void) { return m_pRefractionResourceView; }
