...
CStaticMeshShader::CStaticMeshShader(CDevice * pDevice)
	: CShader(pDevice)
{
}

CStaticMeshShader::CStaticMeshShader(const CStaticMeshShader & rhs)
...
CStaticMeshShader::~CStaticMeshShader(void)
{
	Release();
}

HRESULT CStaticMeshShader::Ready_ShaderFile(const TCHAR * pFilePath)
{
	HRESULT hr = NULL;
...
void CStaticMeshShader::BeginShader(const int & iPassIdx)
{
}

void CStaticMeshShader::EndShader(void)
{
}

HRESULT CStaticMeshShader::SetShaderParameter(XMFLOAT4X4 worldMatrix, XMFLOAT4X4 viewMatrix, XMFLOAT4X4 projectionMatrix,
...
CStaticMeshShader * CStaticMeshShader::Create(CDevice * pDevice, const TCHAR * pFilePath)
{
	CStaticMeshShader*		pShader = new CStaticMeshShader(pDevice);
...
void CStaticMeshShader::Release(void)
{
}

CResource * CStaticMeshShader::Clone(void)
{
	++(*m_pRefCnt);
	return new CStaticMeshShader(*this);
}

void CStaticMeshShader::Update(void)
{
}
