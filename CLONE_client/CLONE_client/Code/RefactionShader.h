...
public:
	static CRefactionShader* Create(CDevice* pDevice, const TCHAR* pFilePath);
	virtual void Release(void);
	virtual	CResource*	Clone(void);
	virtual void		Update(void);

private:
	explicit CRefactionShader(CDevice* pDevice);
	explicit CRefactionShader(const CRefactionShader& rhs);

public:
	virtual ~CRefactionShader(void);
};