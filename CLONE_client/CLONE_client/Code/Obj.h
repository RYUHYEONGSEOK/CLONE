...
public:
	...
	enum ObjCullToRef
	{
		OBJ_RENDER_REF_UNDER,
		OBJ_RENDER_REF_UPPER,
		OBJ_RENDER_REF_BOTH,
		OBJ_RENDER_REF_END
	};
...
protected:
	...
	ObjCullToRef		m_eObjRenderRefType;	//반사를 위한 위쪽, 아래쪽 변수
...
protected:
	...
	CShader*			m_pRefractionShader;
	CShader*			m_pReflectionShader;
	CTexture*			m_pTexture;	
...
public:
	...
	virtual void	RenderForWaterEffect(D3DXVECTOR4 vClipPlane, REFTYPE eRefType)	PURE;
	
	bool			CheckRenderForRef(void);
...
public:
	...
	ObjCullToRef	GetObjRenderRefType(void)		{ return m_eObjRenderRefType; }
