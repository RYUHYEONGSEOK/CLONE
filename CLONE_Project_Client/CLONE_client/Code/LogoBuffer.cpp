...
CLogoBuffer::CLogoBuffer(CDevice * pDevice)
	: CBuffer(pDevice)
{

}

CLogoBuffer::CLogoBuffer(const CLogoBuffer & rhs)
...
CLogoBuffer::~CLogoBuffer(void)
{
	Release();
}


HRESULT CLogoBuffer::CreateBuffer(void)
{
	m_dwVtxCnt = 4;
...
CLogoBuffer * CLogoBuffer::Create(CDevice * pDevice)
{
	CLogoBuffer*		pBuffer = new CLogoBuffer(pDevice);
...
CResource * CLogoBuffer::Clone(void)
{
	++(*m_pRefCnt);
	return new CLogoBuffer(*this);
}

void CLogoBuffer::Render(DXGIFORMATTYPE eFormatType)
{
	CBuffer::Render(eFormatType);
}

void CLogoBuffer::Update()
{

}

void CLogoBuffer::Release()
{

}

void CLogoBuffer::CreateRasterizerState(void)
{
