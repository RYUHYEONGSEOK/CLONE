...
CLogoBackShader::CLogoBackShader(CDevice * pDevice)
	: CShader(pDevice)
{
}

CLogoBackShader::CLogoBackShader(const CLogoBackShader & rhs)
...
CLogoBackShader::~CLogoBackShader(void)
{

}

HRESULT CLogoBackShader::Ready_ShaderFile(const TCHAR * pFilePath)
{
	HRESULT hr = NULL;
...
void CLogoBackShader::BeginShader(const int & iPassIdx)
{
}

void CLogoBackShader::EndShader(void)
{

}

HRESULT CLogoBackShader::SetShaderParameter(XMFLOAT4X4 worldMatrix, XMFLOAT4X4 viewMatrix, XMFLOAT4X4 projectionMatrix,
...
CLogoBackShader * CLogoBackShader::Create(CDevice * pDevice, const TCHAR * pFilePath)
{
	CLogoBackShader*		pShader = new CLogoBackShader(pDevice);
...
void CLogoBackShader::Release(void)
{
}

CResource * CLogoBackShader::Clone(void)
{
	++(*m_pRefCnt);
	return new CLogoBackShader(*this);
}

void CLogoBackShader::Update(void)
{
}
