...
CTextureShader::CTextureShader(CDevice * pDevice)
	: CShader(pDevice)
{
}
...
HRESULT CTextureShader::Ready_ShaderFile(const TCHAR * pFilePath)
{
	HRESULT hr = NULL;
...
void CTextureShader::BeginShader(const int & iPassIdx)
{
}

void CTextureShader::EndShader(void)
{
}

HRESULT CTextureShader::SetShaderParameter(XMFLOAT4X4 worldMatrix, XMFLOAT4X4 viewMatrix, XMFLOAT4X4 projectionMatrix,
	CBuffer*	pBuffer,
...
CTextureShader * CTextureShader::Create(CDevice * pDevice, const TCHAR * pFilePath)
{
	CTextureShader*		pShader = new CTextureShader(pDevice);
...
CResource * CTextureShader::Clone(void)
{
	++(*m_pRefCnt);
	return new CTextureShader(*this);
}

void CTextureShader::Update(void)
{
}
