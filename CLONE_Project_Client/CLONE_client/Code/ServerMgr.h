...
public:
	...
	void SetIsWinOrLose(bool _bIsWinOrLost) { m_bIsWinOrLose = _bIsWinOrLost; }
public:
	...
	inline bool* GetPlayerIsSoloOrTeam(void) { return m_bIsSoloOrTeam; }
	...
	inline bool GetIsWinOrLose(void) { return m_bIsWinOrLose; }
public:
