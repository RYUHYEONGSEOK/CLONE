...
CSkyBoxShader::CSkyBoxShader(CDevice * pDevice)
	: CShader(pDevice)
{
}
...
HRESULT CSkyBoxShader::Ready_ShaderFile(const TCHAR * pFilePath)
{
	HRESULT hr = NULL;
...
void CSkyBoxShader::BeginShader(const int & iPassIdx)
{
}

void CSkyBoxShader::EndShader(void)
{
}

HRESULT CSkyBoxShader::SetShaderParameter(XMFLOAT4X4 worldMatrix, XMFLOAT4X4 viewMatrix, XMFLOAT4X4 projectionMatrix,
	CBuffer* pBuffer,
...
CSkyBoxShader * CSkyBoxShader::Create(CDevice * pDevice, const TCHAR * pFilePath)
{
	CSkyBoxShader*		pShader = new CSkyBoxShader(pDevice);
...
void CSkyBoxShader::Release(void)
{
}

CResource * CSkyBoxShader::Clone(void)
{
	++(*m_pRefCnt);
	return new CSkyBoxShader(*this);
}

void CSkyBoxShader::Update(void)
{
}
